<div class="w3-container w3-card-2 w3-white w3-round" style="margin-left: 10px"><br>
    ...
    <tbody>
    <?php 
		$sql_sel = "select transaksi.*, lapangan.* from transaksi inner join lapangan on (transaksi.id_lap=lapangan.id_lap) where ((status='Telah Dikonfirmasi' or status='Lunas' or status='Selesai' or status='Dibatalkan') and jenis_bayar='transfer') and username='$username'";
